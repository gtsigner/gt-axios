...
a newer version of Go's http2 package, import "zhaojunlike/gt-axios/net/http2"
directly and use its ConfigureTransport and/or ConfigureServer
functions. Manually configuring HTTP/2 via the zhaojunlike/go-http-utls/net/http2
