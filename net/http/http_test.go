...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"zhaojunlike/gt-axios/net/http.(*Client).Get":          true,
		"zhaojunlike/gt-axios/net/http.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"zhaojunlike/gt-axios/net/http.http2Server":           false,
		"zhaojunlike/gt-axios/net/http.(*Server).Serve":       false,
		"zhaojunlike/gt-axios/net/http.(*ServeMux).ServeHTTP": false,
		"zhaojunlike/gt-axios/net/http.DefaultServeMux":       false,
	}
